document.addEventListener("DOMContentLoaded", () => {
    ...
    function firstLevel() {
      foodTypes = [
        "url(images/croissant_70x70.png)",
        "url(images/pancake_70x70.png)",
        "url(images/waffle_70x70.png)",
        "url(images/egg_70x70.png)",
        "url(images/bacon_70x70.png)",
        "url(images/milk_70x70.png)",
      ];
    ...
    function secondLevelStart() {
      location.replace("LevelTwoStart.html")
    }
